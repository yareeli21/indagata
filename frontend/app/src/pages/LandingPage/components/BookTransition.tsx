 ...
 * Secuencia completa de animación del libro
 */
interface BookTransitionProps {
  onDone: () => void;
}

export default function BookTransition({ onDone }: BookTransitionProps) {
  ...
  useEffect(() => {
    ...
    run();
  }, [bookControls, coverControls, onDone, page1Controls, page2Controls, page3Controls]);
    ...
    >
      ...
      >
        ...
        {[page1Controls, page2Controls, page3Controls].map((ctrl, i) => (
          ...
          >
            <TextLines color="rgba(168,213,162,0.10)" count={7 - i} />
            <div
              style={{
                position: 'absolute',
                bottom: '10px',
